...
const Header = () => {
  ...
  return (
    <header className={`md:w-5/6 w-full md:relative md:left-32 top-3 md:rounded-full bg-black isolate bg-nav shadow-lg ring-1 ring-black/5 mb-16 transition-transform duration-300 ${sticky ? 'sticky top-0 z-50' : ''}`}>
      <div className="flex justify-between rounded-full items-center pl-5 pr-5">
        ...
        <div className="hidden md:flex">
          <ul className='flex'>
            ...
            <li className='p-7 text text-white text-1xl'><a href="#history">History</a></li>
      ...
      {isOpen && (
        <div className="md:hidden backdrop-blur-lg rounded-none">
          <ul className='flex flex-col items-center'>
            <li className='p-4 text text-white'><a href="#home">Home</a></li>
            <li className='p-4 text text-white'><a href="#aboutus">About Us</a></li>
            <li className='p-4 text text-white'><a href="#history">History</a></li>
            <li className='p-4 text text-white'><a href="#testimonials">Testimonials</a></li>
            <li className='p-4 '>
